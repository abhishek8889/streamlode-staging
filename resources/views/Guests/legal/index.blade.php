...
<section class="top_banner inner_banner">
    <div class="container text_col">
        ...
        <div class="container text_col">
        <?php if(isset($value) && $value == 'terms-of-services'){ ?>
            <div class="leg-head mb-3">
                <p><a href="{{ url('legal/privacy-policy') }}">Privacy Policy</a></p>
                <h3 class="text-center">Terms and Conditions of Website</h3>
            </div>
            <div style="width: 100%; max-width: 100%; margin: 0 auto;">
                <object data="{{ asset('privacy-policies/Terms-and-Conditions-of-Website.pdf') }}" type="application/pdf" width="100%" height="700px">
                    <iframe src="https://docs.google.com/viewer?url={{ asset('privacy-policies/Terms-and-Conditions-of-Website.pdf') }}&embedded=true" width="100%" height="700px" style="border: none;">
                    </iframe>
                </object>
            </div>
            <!-- <iframe src="https://docs.google.com/viewer?url={{ asset('privacy-policies/Terms-and-Conditions-of-Website.pdf') }}&embedded=true"
            width="100%" height="700" > -->
            <!-- <embed src="https://docs.google.com/viewer?url={{ asset('privacy-policies/Terms-and-Conditions-of-Website.pdf') }}&embedded=true" width="100%" height="700" type="application/pdf"> -->
          
            <!-- <object data="https://docs.google.com/viewer?url={{ asset('privacy-policies/Terms-and-Conditions-of-Website.pdf') }}&embedded=true" width="100%" height="700"></object> -->
        <?php }elseif(isset($value) && $value  == 'privacy-policy'){ ?>
            <div class="leg-head mb-3">
                <p><a href="{{ url('legal/terms-of-services') }}">Terms and Conditions of Website</a></p>
                <h3 class="text-center">Privacy Policy</h3>
            </div>
            <div style="width: 100%; max-width: 100%; margin: 0 auto;">
                <object data="{{ asset('privacy-policies/Privacy-Policy.pdf') }}" type="application/pdf" width="100%" height="700px">
                    <iframe src="https://docs.google.com/viewer?url={{ asset('privacy-policies/Privacy-Policy.pdf') }}&embedded=true" width="100%" height="700px" style="border: none;">
                    </iframe>
                </object>
            </div>
            <!-- <iframe src="https://docs.google.com/viewer?url={{ asset('privacy-policies/Privacy-Policy.pdf') }}&embedded=true"
            width="100%" height="700" > -->
            <!-- <embed src="https://docs.google.com/viewer?url={{ asset('privacy-policies/Privacy-Policy.pdf') }}&embedded=true" width="100%" height="700" type="application/pdf"> -->
        <!-- <object data="https://docs.google.com/viewer?url={{ asset('privacy-policies/Privacy-Policy.pdf') }}&embedded=true" width="100%" height="700"></object> -->
        <?php }else{ ?>
            <ul>
                <li>
                ...
                <li>
                    <a href="{{ url('legal/terms-of-services') }}">Terms and Conditions of Website</a>
                </li>
            </ul>
        <?php  } ?>
            ...
            <div class="About_module">
                <h3>Privacy</h3>
                <p>Please review the Company’s Privacy Policy, which can be found <a href="{{ url('privacy-policy') }}">, to understand our practices.
            ...
            <div class="About_module">
            <a target=”_blank” href="{{ asset('privacy-policies/Terms and Conditions of Website - Veritas Horizon_ L.L.C. - PDF (1) (1).pdf') }}">  <u> <h3> General Terms of Service</h3></u></a>
                <p>
            ...
            <div class="About_module">
            <a target=”_blank” href="{{ asset('privacy-policies/Independent Contractor Agreement - Veritas Horizon L.L.C Website Version.pdf') }}"> <u> <h3 class=""> Entire Agreement/Reservation of Rights</h3></u></a>
                <p>
        ...
        <div class="container text_col">
            <div class=" section-head text-center">
                <a target=”_blank” href="{{ asset('privacy-policies/Privacy-Policy.pdf') }}"><u><h2 class="">Privacy Policy</h2></u></a>
            </div>
            <div class="About_module">
            ...
            <div class="About_module">
              <h3 class="">Release and Indemnification</h3>
